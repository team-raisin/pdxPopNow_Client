...
function ArtistForm({ email, handleSubmit, emailChange }){
  return (
    <>
    <h2>Create Artist Profile</h2>
    <section>
      <form className={styles.createForm} onSubmit={handleSubmit.bind(null, email)}>
        {/* <input type='text' name='artistName' value={artistName} placeholder='Artist Name/Band Name' /> */}
