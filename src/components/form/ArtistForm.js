...
function ArtistForm({ artistName, email, handleSubmit, handleChange }){
  return (
    <>
    <h2>Create Artist Profile</h2>
    <section>
      <form className={styles.createForm} onSubmit={handleSubmit.bind(null, artistName, email)}>
        <input type='text' name='artistName' value={artistName} onChange={handleChange} placeholder='Artist Name/Band Name' />
